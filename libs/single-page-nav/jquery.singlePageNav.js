            ...
            if (!$activeLink.hasClass(this.options.currentClass)) {
                ...
                if ($activeLink.hasClass(this.options.currentClass)) {
                    $activeLink.each(function() {
                        var a = $(this).data('sidebar-img'),
                            b = $(this).text(),
                            $sidebarPicture = $('.sidebar-picture');

                        $sidebarPicture.addClass('animate');
                        setTimeout(function() {
                            $sidebarPicture.find('.sidebar-picture__text').html(b);
                            if (a) {
                                $sidebarPicture.css('background-image', 'url(' + a + ')');
                            }
                        }, 200);
                        setTimeout(function() {
                            $sidebarPicture.removeClass('animate');
                        }, 400);
                    });
                }
            }
